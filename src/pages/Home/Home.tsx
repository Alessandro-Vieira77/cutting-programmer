        ...
        <main className="flex flex-col items-center w-full max-w-5xl border-2 border-green-400 mt-7">
          ...
          <section className=" w-full flex-wrap md:flex-nowrap max-w-5xl flex gap-7 mt-7 border-4 border-violet-900">
            ...
            <div className="flex flex-col gap-7 w-full md:max-w-25.1">
              <div className="flex md:hidden justify-center items-center text-justify px-2 w-full h-24  bg-azul rounded-lg">
                {/* description */}
              ...
              <div className="w-full md:max-w-25.1 h-35.75 bg-azul pl-5 pr-5 border-2 rounded-xl">
                <h2 className="text-white font-medium text-2xl mt-6">
                  Serviços
                </h2>
                <p className="text-white mt-6">
                  Selecione abaixo qual serviço deseja realizar o agendamento
                </p>
                <div className="flex flex-col gap-2.5 w-full h-80 overflow-y-auto mt-6">
                  <div className="flex justify-center items-center w-full h-9 bg-white rounded-xl font-medium">
                    Corte Normal
                  </div>
                  <div className="flex justify-center items-center w-full h-9 bg-white rounded-xl font-medium">
                    Barba
              ...
              <div className="max-w-25.1 h-35.75  border-2 border-blue-400"></div>
            </div>
            {/* Description, contact and temps */}
            <div className="flex flex-col gap-7 w-full  border-4 border-violet-900">
              <div className="hidden md:flex justify-center items-center text-justify px-2 w-full h-24  bg-azul rounded-lg">
                {/* description */}
                <p className="md:text-sm text-xs text-white">
                  Na [Nome da Barbearia], acreditamos que um bom corte de cabelo
                  e barba vão além da estética – é um momento de cuidado, estilo
              ...
              <div className="w-full h-35.75  border-2 border-amber-400">
                <h2>Contato</h2>
                <img src="" alt="" />
                <p>(98) 985467978</p>
              </div>
